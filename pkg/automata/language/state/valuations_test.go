...
func Test_Value(t *testing.T) {
	...
	valuations := NewValuationsMap[expressions.Expression]()
	zero, one := expressions.NewInteger(0), expressions.NewInteger(1)
	two, three := expressions.NewInteger(2), expressions.NewInteger(3)
