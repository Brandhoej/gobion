...
func (printer PrettyPrinter) Constraint(constraint Constraint) {
	...
	case AssignmentConstraint:
		printer.AssignmentConstraint(cast)
...
func (printer PrettyPrinter) AssignmentConstraint(constraint AssignmentConstraint) {
	printer.statements.Assignment(constraint.assignment)
}
